 ...
 *
 * <ul>
 * <li>mode: Can be "generate", "encrypt" or "decrypt". If mode is "generate",
 * it will generate a keyset, encrypt it and store it in the key-file argument.
 * If mode is "encrypt" or "decrypt", it will read and decrypt an keyset from
 * the key-file argument, and use it to encrypt or decrypt the input-file
 * argument.
 * <li>kek-uri: Use this Cloud KMS' key as the key-encrypting-key for envelope
 * encryption.
 * <li>gcp-credential-file: Use this JSON credential file to connect to Cloud
 * KMS.
...
public final class EncryptedKeysetExample {
	...
	public static void main(String[] args) throws Exception {
		if (args.length != 4 && args.length != 6) {
			...
			System.err.println("Usage: java EncryptedKeysetExample generate/encrypt/decrypt key-file kek-uri"
		...
		// From the key-encryption key (KEK) URI, create a remote AEAD primitive for
		// encrypting Tink
		// keysets.
		Aead kekAead = null;
		try {
