...
import de.tgmz.zdev.transfer.upload.HfsUploadHandler;

public class HfsUploadHandlerTest {
	private static class Runner implements Runnable {
		...
		@Override
		public void run() {
			new HfsUploadHandler().execute(event);
		}
	}
	@Test
	public void executeTest() {
		...
		context.addVariable(ISources.ACTIVE_CURRENT_SELECTION_NAME, new StructuredSelection(Mockito.mock(IFile.class)));
