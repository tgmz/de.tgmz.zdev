 ...
 * @since 2.0
 */
public TextAreaFieldEditor(String name, String labelText, int width, int strategy, Composite parent) {
	init(name, labelText);
	widthInChars = width;
 ...
 * @param parent the parent of the field editor's control
 */
public TextAreaFieldEditor(String name, String labelText, int width, Composite parent) {
...
public String getStringValue() {
	return textField != null ? textField.getText() : getPreferenceStore().getString(getPreferenceName());
}
/**
 ...
 *
 * @param aValue the new value, or <code>null</code> meaning the empty string
 */
public void setStringValue(String aValue) {
	if (textField != null) {
		String s = aValue != null ? aValue : ""; 
